...
public class NavigateandCreateOrder {
	...
	public void createandupdateProduct() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Manufacturing')]")));
		driver.findElement(By.xpath("//span[contains(text(),'Manufacturing')]")).click();
		
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[@title='Total Qty']")));
		driver.findElement(By.xpath("//button[contains(text(),'Create')]")).click();
